...
class QueryBuilder
{
    protected Search|BoolQuery $query;
    ...
    public function getQuery(): BoolQuery|Search
    {
        return $this->query;
    }
     ...
     * @return $this
     */
    public function where(array|string|\Closure $field, mixed $operator = null, mixed $value = null, ?array $parameters = [], $occur = BoolQuery::FILTER): static
    {
     ...
     * @return $this
     */
    public function whereIn(string $field, array $values, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereBetween(string $field, array $values, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereExists(string $field, ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereRegexp(string $field, string $value, string $flags = 'ALL', ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereLike(string $field, string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function wherePrefix(string $field, string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereFuzzy(string $field, string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereIdsIn(array $values, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereGeoDistance(string $field, string $distance, $location, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereGeoBoundingBox(string $field, array $values, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereGeoPolygon(string $field, array $points, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereGeoShape(\Closure $closure, array $parameters = ['relation' => 'INTERSECTS'], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereMatchAll(array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereMatch(string $field, string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereMultiMatch(array $fields, string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereMatchPhrase(string $field, string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereMatchPhrasePrefix(string $field, string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereQueryString(string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereSimpleQueryString(string $value, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @return $this
     */
    public function whereNested(string $path, \Closure $callback, array $parameters = [], ?string $occur = null): static
    {
     ...
     * @throws \ReflectionException
     */
    protected function magicCallWhereCondition(string $name, array $arguments, string $occur): static
    {
